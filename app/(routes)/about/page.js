...
const AboutMe = () => {
  ...
  return (
    <div
      ref={aboutRef}
      className="min-h-screen dark:bg-[#070f22] bg-white py-20 px-4"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-12 items-center mb-20">
          ...
          >
            ...
            <motion.p
              ...
              className="dark:text-gray-300 text-gray-700 text-lg leading-relaxed mb-4"
            >
            ...
            <motion.p
              ...
              className="dark:text-gray-300 text-gray-700 text-lg leading-relaxed mb-8"
            >
            ...
            <motion.button
              ...
              className="flex items-center gap-3 text-white bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 px-6 py-3 rounded-lg hover:scale-105 transition duration-300 shadow-lg hover:shadow-xl"
            >
              Download Resume →
            </motion.button>
          </motion.div>
        ...
        <motion.div
          ...
          className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8 mb-20"
        >
          {stats.map((stat, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <h3 className="dark:text-white text-gray-800 text-3xl font-bold mb-2">
                {stat.value}
              </h3>
          ...
          <div className="space-y-8">
            {journey.map((item, i) => (
              <motion.div
                ...
                animate={aboutInView ? { opacity: 1, x: 0 } : {}}
                transition={{ duration: 0.8, delay: 1.9 + i * 0.2 }}
              ...
              >
                ...
                <div className="flex-1 dark:bg-[#0d1224] bg-gray-50 p-6 rounded-xl border dark:border-gray-700 border-gray-300 hover:shadow-xl transition duration-300">
                  ...
                  <h3 className="dark:text-white text-gray-800 text-xl font-bold mt-2 mb-2">
                    {item.title}
                  </h3>
        ...
        <motion.div
          ...
          className="text-center dark:bg-[#0d1224] bg-gray-50 p-12 rounded-2xl border dark:border-gray-700 border-gray-300 shadow-xl"
        >
          ...
          <p className="dark:text-gray-400 text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            ...
            Whether it's a startup MVP or an enterprise solution, let's make it happen.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <button className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-medium hover:scale-105 transition duration-300 shadow-lg">
              Get in Touch
            </button>
            <button className="px-8 py-3 dark:bg-transparent bg-white dark:text-white text-gray-800 border-2 dark:border-gray-600 border-gray-300 rounded-lg font-medium hover:scale-105 transition duration-300">
              View Portfolio
            </button>
          </div>
        </motion.div>
